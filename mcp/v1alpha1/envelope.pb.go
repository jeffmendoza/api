...
func (*Envelope) Descriptor() ([]byte, []int) {
	return fileDescriptor_envelope_ccd7c910ce2dbafa, []int{0}
}
...
func (m *Envelope) GetResource() *types.Any {
	if m != nil {
		return m.Resource
	}
	return nil
...
func init() {
	proto.RegisterFile("mcp/v1alpha1/envelope.proto", fileDescriptor_envelope_ccd7c910ce2dbafa)
}

var fileDescriptor_envelope_ccd7c910ce2dbafa = []byte{
