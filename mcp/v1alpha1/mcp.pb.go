...
package v1alpha1 // import "istio.io/api/mcp/v1alpha1"
...
type Client struct {
	...
	Metadata             *types.Struct `protobuf:"bytes,2,opt,name=metadata" json:"metadata,omitempty"`
...
func (*Client) Descriptor() ([]byte, []int) {
	return fileDescriptor_mcp_e1550b39ac0b55e3, []int{0}
}
...
func (m *Client) GetMetadata() *types.Struct {
	if m != nil {
		return m.Metadata
	}
	return nil
...
type MeshConfigRequest struct {
	...
	// versions.
	ErrorDetail          *rpc.Status `protobuf:"bytes,5,opt,name=error_detail,json=errorDetail" json:"error_detail,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (*MeshConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_mcp_e1550b39ac0b55e3, []int{1}
}
...
func (dst *MeshConfigRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfigRequest.Merge(dst, src)
}
...
func (*MeshConfigResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_mcp_e1550b39ac0b55e3, []int{2}
}
...
func (dst *MeshConfigResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshConfigResponse.Merge(dst, src)
}
...
func (*IncrementalMeshConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_mcp_e1550b39ac0b55e3, []int{3}
}
...
func (dst *IncrementalMeshConfigRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IncrementalMeshConfigRequest.Merge(dst, src)
}
...
func (*IncrementalMeshConfigResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_mcp_e1550b39ac0b55e3, []int{4}
}
...
func (dst *IncrementalMeshConfigResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IncrementalMeshConfigResponse.Merge(dst, src)
}
...
func init() { proto.RegisterFile("mcp/v1alpha1/mcp.proto", fileDescriptor_mcp_e1550b39ac0b55e3) }

var fileDescriptor_mcp_e1550b39ac0b55e3 = []byte{
