...
func (AuthenticationPolicy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_proxy_46476ecf080f84e2, []int{0}
}
...
func (ProxyConfig_InboundInterceptionMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_proxy_46476ecf080f84e2, []int{1, 0}
}
...
func (*Tracing_Zipkin) Descriptor() ([]byte, []int) {
	return fileDescriptor_proxy_46476ecf080f84e2, []int{0, 0}
}
...
func (dst *Tracing_Zipkin) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Tracing_Zipkin.Merge(dst, src)
}
...
func (*Tracing_Lightstep) Descriptor() ([]byte, []int) {
	return fileDescriptor_proxy_46476ecf080f84e2, []int{0, 1}
}
...
func (dst *Tracing_Lightstep) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Tracing_Lightstep.Merge(dst, src)
}
...
type ProxyConfig struct {
	...
	DrainDuration *types.Duration `protobuf:"bytes,4,opt,name=drain_duration,json=drainDuration" json:"drain_duration,omitempty"`
	...
	ParentShutdownDuration *types.Duration `protobuf:"bytes,5,opt,name=parent_shutdown_duration,json=parentShutdownDuration" json:"parent_shutdown_duration,omitempty"`
	...
	ConnectTimeout *types.Duration `protobuf:"bytes,9,opt,name=connect_timeout,json=connectTimeout" json:"connect_timeout,omitempty"`
...
func (*ProxyConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_proxy_46476ecf080f84e2, []int{1}
}
...
func init() { proto.RegisterFile("mesh/v1alpha1/proxy.proto", fileDescriptor_proxy_46476ecf080f84e2) }

var fileDescriptor_proxy_46476ecf080f84e2 = []byte{
