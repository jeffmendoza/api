...
func (*Network) Descriptor() ([]byte, []int) {
	return fileDescriptor_network_d4bec539d41587c9, []int{0}
}
...
func (*Network_NetworkEndpoints) Descriptor() ([]byte, []int) {
	return fileDescriptor_network_d4bec539d41587c9, []int{0, 0}
}
...
func (dst *Network_NetworkEndpoints) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Network_NetworkEndpoints.Merge(dst, src)
}
...
func (*Network_IstioNetworkGateway) Descriptor() ([]byte, []int) {
	return fileDescriptor_network_d4bec539d41587c9, []int{0, 1}
}
...
func (dst *Network_IstioNetworkGateway) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Network_IstioNetworkGateway.Merge(dst, src)
}
...
func (*MeshNetworks) Descriptor() ([]byte, []int) {
	return fileDescriptor_network_d4bec539d41587c9, []int{1}
}
...
func (dst *MeshNetworks) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MeshNetworks.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mesh/v1alpha1/network.proto", fileDescriptor_network_d4bec539d41587c9)
}

var fileDescriptor_network_d4bec539d41587c9 = []byte{
