...
func (MeshConfig_IngressControllerMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_54815a68bfd5fd31, []int{0, 0}
}
...
func (MeshConfig_AuthPolicy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_config_54815a68bfd5fd31, []int{0, 1}
}
...
type MeshConfig struct {
	...
	ConnectTimeout *types.Duration `protobuf:"bytes,6,opt,name=connect_timeout,json=connectTimeout" json:"connect_timeout,omitempty"`
...
func (*MeshConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_54815a68bfd5fd31, []int{0}
}
...
func init() { proto.RegisterFile("mesh/v1alpha1/config.proto", fileDescriptor_config_54815a68bfd5fd31) }

var fileDescriptor_config_54815a68bfd5fd31 = []byte{
