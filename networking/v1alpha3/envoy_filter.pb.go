...
func (EnvoyFilter_ListenerMatch_ListenerType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_envoy_filter_e1cbb66ad419862d, []int{0, 1, 0}
}
...
func (EnvoyFilter_ListenerMatch_ListenerProtocol) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_envoy_filter_e1cbb66ad419862d, []int{0, 1, 1}
}
...
func (EnvoyFilter_InsertPosition_Index) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_envoy_filter_e1cbb66ad419862d, []int{0, 2, 0}
}
...
func (EnvoyFilter_Filter_FilterType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_envoy_filter_e1cbb66ad419862d, []int{0, 3, 0}
}
...
func (*EnvoyFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_envoy_filter_e1cbb66ad419862d, []int{0}
}
...
func (dst *EnvoyFilter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EnvoyFilter.Merge(dst, src)
}
...
func (*EnvoyFilter_ListenerMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_envoy_filter_e1cbb66ad419862d, []int{0, 1}
}
...
func (dst *EnvoyFilter_ListenerMatch) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EnvoyFilter_ListenerMatch.Merge(dst, src)
}
...
func (*EnvoyFilter_InsertPosition) Descriptor() ([]byte, []int) {
	return fileDescriptor_envoy_filter_e1cbb66ad419862d, []int{0, 2}
}
...
func (dst *EnvoyFilter_InsertPosition) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EnvoyFilter_InsertPosition.Merge(dst, src)
}
...
type EnvoyFilter_Filter struct {
	...
	// instantiated.
	FilterConfig         *types.Struct `protobuf:"bytes,5,opt,name=filter_config,json=filterConfig" json:"filter_config,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (*EnvoyFilter_Filter) Descriptor() ([]byte, []int) {
	return fileDescriptor_envoy_filter_e1cbb66ad419862d, []int{0, 3}
}
...
func (dst *EnvoyFilter_Filter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EnvoyFilter_Filter.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("networking/v1alpha3/envoy_filter.proto", fileDescriptor_envoy_filter_e1cbb66ad419862d)
}

var fileDescriptor_envoy_filter_e1cbb66ad419862d = []byte{
