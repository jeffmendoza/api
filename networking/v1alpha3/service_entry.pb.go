...
func (ServiceEntry_Location) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_service_entry_1611847b261974d7, []int{0, 0}
}
...
func (ServiceEntry_Resolution) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_service_entry_1611847b261974d7, []int{0, 1}
}
...
func (*ServiceEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_entry_1611847b261974d7, []int{0}
}
...
func (dst *ServiceEntry_Endpoint) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ServiceEntry_Endpoint.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("networking/v1alpha3/service_entry.proto", fileDescriptor_service_entry_1611847b261974d7)
}

var fileDescriptor_service_entry_1611847b261974d7 = []byte{
