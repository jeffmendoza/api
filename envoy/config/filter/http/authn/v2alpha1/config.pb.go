...
package v2alpha1 // import "istio.io/api/envoy/config/filter/http/authn/v2alpha1"
...
type FilterConfig struct {
	...
	Policy *v1alpha1.Policy `protobuf:"bytes,1,opt,name=policy" json:"policy,omitempty"`
...
func (*FilterConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_c1ae0b8b75d89181, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/http/authn/v2alpha1/config.proto", fileDescriptor_config_c1ae0b8b75d89181)
}

var fileDescriptor_config_c1ae0b8b75d89181 = []byte{
