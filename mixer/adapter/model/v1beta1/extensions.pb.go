...
func (TemplateVariety) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_extensions_999a56b4de4492d6, []int{0}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/model/v1beta1/extensions.proto", fileDescriptor_extensions_999a56b4de4492d6)
}

var fileDescriptor_extensions_999a56b4de4492d6 = []byte{
