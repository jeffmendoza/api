...
func (*QuotaRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_quota_cb337ef8c3a3c4de, []int{0}
}
...
func (*QuotaRequest_QuotaParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_quota_cb337ef8c3a3c4de, []int{0, 0}
}
...
func (dst *QuotaRequest_QuotaParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QuotaRequest_QuotaParams.Merge(dst, src)
}
...
func (*QuotaResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_quota_cb337ef8c3a3c4de, []int{1}
}
...
func (dst *QuotaResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QuotaResult.Merge(dst, src)
}
...
func (*QuotaResult_Result) Descriptor() ([]byte, []int) {
	return fileDescriptor_quota_cb337ef8c3a3c4de, []int{1, 0}
}
...
func (dst *QuotaResult_Result) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QuotaResult_Result.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mixer/adapter/model/v1beta1/quota.proto", fileDescriptor_quota_cb337ef8c3a3c4de)
}

var fileDescriptor_quota_cb337ef8c3a3c4de = []byte{
