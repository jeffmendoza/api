...
func (*ReportResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_report_71bf080b2d49239e, []int{0}
}
...
func init() {
	proto.RegisterFile("mixer/adapter/model/v1beta1/report.proto", fileDescriptor_report_71bf080b2d49239e)
}

var fileDescriptor_report_71bf080b2d49239e = []byte{
