...
type HTTPAPISpec struct {
	...
	Attributes *v1.Attributes `protobuf:"bytes,1,opt,name=attributes" json:"attributes,omitempty"`
...
func (*HTTPAPISpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_spec_6da61c3437ddaa34, []int{0}
}
...
func (*HTTPAPISpecPattern) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_spec_6da61c3437ddaa34, []int{1}
}
...
func (dst *HTTPAPISpecPattern) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HTTPAPISpecPattern.Merge(dst, src)
}
...
func (*APIKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_spec_6da61c3437ddaa34, []int{2}
}
...
func (*HTTPAPISpecReference) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_spec_6da61c3437ddaa34, []int{3}
}
...
func (dst *HTTPAPISpecReference) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HTTPAPISpecReference.Merge(dst, src)
}
...
func (*HTTPAPISpecBinding) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_spec_6da61c3437ddaa34, []int{4}
}
...
func (dst *HTTPAPISpecBinding) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HTTPAPISpecBinding.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mixer/v1/config/client/api_spec.proto", fileDescriptor_api_spec_6da61c3437ddaa34)
}

var fileDescriptor_api_spec_6da61c3437ddaa34 = []byte{
