...
func (*QuotaSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_quota_2e0e659245e6dcae, []int{0}
}
...
func (*QuotaRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_quota_2e0e659245e6dcae, []int{1}
}
...
func (dst *QuotaRule) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QuotaRule.Merge(dst, src)
}
...
func (*StringMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_quota_2e0e659245e6dcae, []int{2}
}
...
func (*AttributeMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_quota_2e0e659245e6dcae, []int{3}
}
...
func (dst *AttributeMatch) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AttributeMatch.Merge(dst, src)
}
...
func (*Quota) Descriptor() ([]byte, []int) {
	return fileDescriptor_quota_2e0e659245e6dcae, []int{4}
}
...
func (*QuotaSpecBinding) Descriptor() ([]byte, []int) {
	return fileDescriptor_quota_2e0e659245e6dcae, []int{5}
}
...
func (dst *QuotaSpecBinding) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QuotaSpecBinding.Merge(dst, src)
}
...
func (*QuotaSpecBinding_QuotaSpecReference) Descriptor() ([]byte, []int) {
	return fileDescriptor_quota_2e0e659245e6dcae, []int{5, 0}
}
...
func (dst *QuotaSpecBinding_QuotaSpecReference) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QuotaSpecBinding_QuotaSpecReference.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("mixer/v1/config/client/quota.proto", fileDescriptor_quota_2e0e659245e6dcae)
}

var fileDescriptor_quota_2e0e659245e6dcae = []byte{
