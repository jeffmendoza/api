...
func (*IstioService) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_3b903e5bb5cfa17c, []int{0}
}
...
func init() {
	proto.RegisterFile("mixer/v1/config/client/service.proto", fileDescriptor_service_3b903e5bb5cfa17c)
}

var fileDescriptor_service_3b903e5bb5cfa17c = []byte{
