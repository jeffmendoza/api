...
func (*Attributes) Descriptor() ([]byte, []int) {
	return fileDescriptor_attributes_72892766eb05d825, []int{0}
}
...
func (*Attributes_AttributeValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_attributes_72892766eb05d825, []int{0, 1}
}
...
func (dst *Attributes_AttributeValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Attributes_AttributeValue.Merge(dst, src)
}
...
type Attributes_AttributeValue_TimestampValue struct {
	TimestampValue *types.Timestamp `protobuf:"bytes,7,opt,name=timestamp_value,json=timestampValue,oneof"`
}
type Attributes_AttributeValue_DurationValue struct {
	DurationValue *types.Duration `protobuf:"bytes,8,opt,name=duration_value,json=durationValue,oneof"`
}
...
func (*Attributes_StringMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_attributes_72892766eb05d825, []int{0, 2}
}
...
func (dst *Attributes_StringMap) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Attributes_StringMap.Merge(dst, src)
}
...
func (*CompressedAttributes) Descriptor() ([]byte, []int) {
	return fileDescriptor_attributes_72892766eb05d825, []int{1}
}
...
func (dst *CompressedAttributes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CompressedAttributes.Merge(dst, src)
}
...
func (*StringMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_attributes_72892766eb05d825, []int{2}
}
...
func init() {
	proto.RegisterFile("mixer/v1/attributes.proto", fileDescriptor_attributes_72892766eb05d825)
}

var fileDescriptor_attributes_72892766eb05d825 = []byte{
